 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class Note extends MYDimension  implements MYDimensionImpl
{
	 ...
	 * @param componenttype
	 */
	public GraphComponentContainer graphcomp=null;
	public Note(int startx, int starty, String note,GraphComponentContainer graphcomp)
	{
	...
	public void drawComponent(Graphics g)
	{
		...
		g.fillRect(this.startx,this.starty,this.endx-this.startx,this.endy-this.starty);
