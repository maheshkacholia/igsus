 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class SetGraphProperty extends JFrame implements ListSelectionListener, KeyListener, ActionListener, MouseListener
{
	...
	public SetGraphProperty()
	{
		...
		this.setTitle("Set Graph Property");
		this.move(300, 300);
	...
	private javax.swing.JPanel getJContentPane()
	{
		...
		JLabel lable = new JLabel("Select Category");
		...
		JLabel lable1 = new JLabel("Select Stcok  :");
		lable1.setFont(new Font("Arial", Font.PLAIN, 12));
		...
		JLabel lable2 = new JLabel("Selected Stcok  :");
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if( o instanceof JComboBox)
		{
			...
			String inexName = (String)cb.getSelectedItem();
	...
	{
		SetGraphProperty addremove = new SetGraphProperty();
	}
	/* (non-Javadoc)
