 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class SelectStockList extends JFrame implements ListSelectionListener, KeyListener, ActionListener, MouseListener
{
	...
	public SelectStockList(MainframeInterface mainframe)
	{
		...
		this.setTitle("Add/Remove Stock For Alert");
		this.move(300, 100);
	...
	private javax.swing.JPanel getJContentPane()
	{
		...
		stockCode = Utility.getAlertStockCode();;
		...
		selectedStock = this.mainframe.getSelectedStockList();
		list1 = new JList(selectedStock);
...
//			list1.
		...
		else if (o instanceof JButton)
		{
			...
			else if (name.equalsIgnoreCase("ok"))
			{
				...
				{
					if(i < selectedStock.size() - 1)
						sb.append(selectedStock.get(i)+ ",");
					else
						sb.append(selectedStock.get(i));
						
				}
				mainframe.updateStockList(sb.toString());
				this.dispose();
			} 
	...
	{
		SelectStockList addremove = new SelectStockList(null);
	}
	/* (non-Javadoc)
