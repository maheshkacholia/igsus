...
public class IntradayPanelFor2GraphFrame extends JFrame implements ComponentListener,WindowListener,ActionListener
{
	Button b;
	public PanelFor2GraphIntraday macd;
	String symbol;
	boolean intraday=false;

	public IntradayPanelFor2GraphFrame()
	{
...
//		this.macd.doIntraday();
	...
	private javax.swing.JPanel getJContentPane() 
	{
		...
		this.symbol = "ACC";
		macd = new PanelFor2GraphIntraday(0, ystart, StockConstants.length,StockConstants.height,true,true);
