 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public  class PanelFor4Graph extends JPanel implements PanelForGraphImpl
{
	/**
	 * This is the default constructor
	 */
	public PanelFor4Graph()
	{
		super();
		initialize();
	}
	...
	public PanelFor4Graph(int x1, int y1, int x2, int y2)
	{
		super(null);
		...
		panel1 = new PanelForGraph(0,0,x2/2,y2/2,com.stockfaxforu.util.StockConstants.SELECTED_STOCK);
		panel1.setBounds(0,0,x2/2,y2/2);
		add(panel1,null);
		
		panel2 = new PanelForGraph(0,0,x2/2,y2/2,com.stockfaxforu.util.StockConstants.SELECTED_STOCK);
		panel2.setBounds(x2/2+1,0,x2/2,y2/2);
		add(panel2,null);
		
		panel3 = new PanelForGraph(0,0,x2/2,y2/2,com.stockfaxforu.util.StockConstants.SELECTED_STOCK);
		panel3.setBounds(0,y2/2+1,x2/2,y2/2);

		add(panel3,null);
		
		panel4 = new PanelForGraph(0,0,x2/2,y2/2,com.stockfaxforu.util.StockConstants.SELECTED_STOCK);
	...
	public static void main(String[] args)
	{
		...
		PanelFor4Graph d = new PanelFor4Graph(0, 0, 1300, 900);
