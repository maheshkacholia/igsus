 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public  class PanelFor2GraphIntraday extends JPanel implements PanelForGraphImpl
{
	/**
	 * This is the default constructor
	 */
	public PanelFor2GraphIntraday()
	{
		super();
		initialize();
	}
	...
	public PanelFor2GraphIntraday(int x1, int y1, int x2, int y2,boolean intraday,boolean shortscreen)
	{
		super(null);
		...
		panel1 = new PanelForGraph(0,0,x2/2,y2-50,com.stockfaxforu.util.StockConstants.SELECTED_STOCK,intraday,shortscreen);
		panel1.setBounds(0,0,x2/2,y2);
		add(panel1,null);
		
		panel2 = new PanelForGraph(0,0,x2/2,y2-50,com.stockfaxforu.util.StockConstants.SELECTED_STOCK,intraday,shortscreen);
	...
	public static void main(String[] args)
	{
		...
		PanelFor2GraphIntraday d = new PanelFor2GraphIntraday(0, 0, 1300, 900,true,true);
