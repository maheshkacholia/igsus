 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class ToolScreenPanel extends JFrame
{
	public ToolScreenPanel()
	{
...
//		 this.getRootPane().setWindowDecorationStyle(JRootPane.PLAIN_DIALOG); 
		Image im1 = Toolkit.getDefaultToolkit().getImage(ClassLoader.getSystemResource("image/toolicon.jpg"));
	...
	private javax.swing.JPanel getJContentPane()
	{
		...
		if (jContentPane == null)
		{
			...
			button.setBounds(0, 0, this.getWidth(), 70);
			...
			lable.setBounds(5, 75, this.getWidth()-10, 15);
			...
			lable1.setBounds(5, 90, this.getWidth()-10, 15);
			...
			lable2.setBounds(5, 110, this.getWidth()-10, 10);
