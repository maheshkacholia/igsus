 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class NewFormulaNameBoxStockScanner extends JFrame implements ActionListener
{
	/**
	...
	public NewFormulaNameBoxStockScanner(String formula)
	{
		//		super(null);
		...
		this.setTitle("New Formula Name Screen");
		this.move(300, 300);
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if (o instanceof JButton)
		{
			...
			if (name.equalsIgnoreCase("add"))
			{
				...
				StrategyUtilityStockScreener.saveFormula(lformulatype,lformulaname,this.formula,"");
				this.dispose();
			} 
