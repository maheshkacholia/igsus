 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class CustmizedIndicatorBuilderScreen extends FormulaBuilderScreen implements ActionListener,ListSelectionListener,WindowListener
{
	/**
...
/*	
	...
	JComboBox combobox;
*/
	public CustmizedIndicatorBuilderScreen()
	...
	public CustmizedIndicatorBuilderScreen(PanelForGraph maingraph,String s,boolean b)
	{
//		super(maingraph,s,b);
	...
	public CustmizedIndicatorBuilderScreen(PanelForGraph panelforgraph)
	{
//		super(null);
		setBackground(Color.lightGray);
	...
	private javax.swing.JPanel getJContentPane() 
	{
		...
		this.setTitle("Custmized Indicator Builder Screen");
		int xinc = 10;
		int yinc = 35;
		int xincdis=70;
...
*/		 
	...
	String[] gifname1 = {"newformula.jpg","open.jpg","save.jpg", "saveas.jpg","runstrategy.jpg"};

	String[] desc = {"Create a New Custmized Indicator","Open a Custmized Indicator","Save Custmized Indicator", "Saveas","Execute Formula"};
...
*/
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		if(o instanceof JButton)
		{
			...
			if(name.equalsIgnoreCase("addindicator"))
			{
...
//				newformula.operationname = name;							
			...
			{
				String s = this.fordispanel.getFormula();
				String s1 = this.formulaName.getText();
...
//					newformula.operationname = name;							
				...
				{
					String formula = fordispanel.getFormula();
					String formulanName = formulaName.getText();
					String formulaType = this.formulaType.getText();
					this.saveFormula(formula,formulanName,formulaType,s1,"");
				}
			}
...
//				newformula.operationname = name;
			...
			{
				panelforgraph.executeCustmizedIndicator(formulaName.getText(),fordispanel.getFormula());
...
//				this.dispose();
	...
	{
			StrategyUtilityCustmizedIndicator.saveFormula(formulaType,formulanName,formula,comment);
	}
	...
	public static void main(String[] args)
		{
			...
			CustmizedIndicatorBuilderScreen d = new CustmizedIndicatorBuilderScreen(null);
		}
	/* (non-Javadoc)
