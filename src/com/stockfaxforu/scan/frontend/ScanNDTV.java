...
public class ScanNDTV extends JPanel implements ListSelectionListener, KeyListener, ActionListener, MouseListener
{
	...
	public ScanNDTV(int x1, int y1,int type)
	{
		super(null);
		this.xmax = x1;
		this.ymax = y1;
...
*/		
	...
	{
		ScanNDTV s = new ScanNDTV(1000, 800,1);
	}
	/* (non-Javadoc)
		...
		try
		{
			...
			if (obj instanceof JButton)
			{
				...
				else if (name.equals("submit"))
				{
					...
					System.out.println("minperchange=="+minperchange);
