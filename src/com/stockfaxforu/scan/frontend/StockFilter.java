 ...
 * Window&gt;Preferences&gt;Java&gt;Code Generation&gt;Code and Comments
 */
public class StockFilter extends JPanel implements StockFilterInterface,FrameDataInterface,ActionListener, ListSelectionListener, WindowListener,MouseListener,KeyListener
{
	/**
	...
	private static int GRAPH_DIFF=550;
	public StockFilter()
	{
		super();
		initialize();
	...
	public StockFilter(int xmax,int ymax)
	{
		//		super(null);
		this.xmax = xmax;
		this.ymax = ymax;
...
//		columnNames =  {"Symbol","Open","High","Low","Close","Buy/Sell","Pattern"};
		...
		outputResultTable.addKeyListener(this);
		
		tableheader = outputResultTable.getTableHeader();
		tableheader.addMouseListener(this);	
		
		tableheader.addKeyListener(this);	
		...
		outputResultTableScrollPane.setBounds(0,yinc, xmax-GRAPH_DIFF, ymax-yinc);
					
		this.add( outputResultTableScrollPane, null );

		panel = new PanelForGraph(0, 0, GRAPH_DIFF ,ymax-yinc-80 , StockConstants.SELECTED_STOCK);
		panel.macdgraph.showstats=false;
		panel.setBounds(xmax-GRAPH_DIFF,yinc ,xmax-GRAPH_DIFF, ymax-yinc);
//	setBackground(StockConstants.graphbackgroundcolor);
	...
	String[] gifname = {  "addtotree", "selectstockcategory","new","selectformula","save","saveas","Apply", "csv","formula","formulaapi","help"};
	String[] gifname1 = { "addtotree.jpg",  "find_small.jpg",  "newformula.jpg",   "open.jpg", "save.jpg", "saveas.jpg",   "runstrategy.jpg","csv.jpg","formula.jpg","formulaapi.jpg","help.jpg"};
	String[] desc = {  "Add Result to Tree", 
                       "Select Category","New Formula",
                       "Select IGS Query","Save IGS Query","Save As","Execute IGS Query","Download File as CSV","Filter Building  Screen","API Help","Help"};
...
//				dispose();
		...
		//			e1.printStackTrace();
			...
			*/
			...
			else if(name.equals("formulaapi"))
			{
					HelpWindow searc = new HelpWindow(null);
			}
			else if (name.equals("help"))
			{
				ShowContentWindow searc = new ShowContentWindow(StockConstants.INSTALL_DIR + "/help","stockfilter.html");
	...
	public void addTable()
	{
		if(outputResultTableScrollPane != null && outputResultTable != null)
			...
			// Add the table to a scrolling pane
			outputResultTableScrollPane = JTable.createScrollPaneForTable( outputResultTable );
			outputResultTableScrollPane.setBounds(0,yinc, xmax-GRAPH_DIFF, ymax-yinc-80);
...
//				String[] temp = ScanUtility.getSymbolDetail(s,outputField);
	...
	{
		JFrame f = new JFrame();
		StockFilter newscan = new StockFilter(1000,1000);
